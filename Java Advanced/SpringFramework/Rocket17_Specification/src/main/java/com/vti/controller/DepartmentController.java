...
public class DepartmentController {
	...
	@GetMapping()
	public ResponseEntity<?> getAllDepartments(Pageable paging,
			@RequestParam(name = "search", required = false) String search, DepartmentFilterForm departmentFilter) throws ParseException {
		Page<Department> entities = service.getAllDepartments(paging, search, departmentFilter);
