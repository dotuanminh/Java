...
public class DepartmentController {
	...
	@GetMapping()
	public ResponseEntity<?> getAllDepartments(Pageable paging,@RequestParam(name="search",required= false)String search,DepartmentFilter filter) {
		Page<Department> entities = service.getAllDepartments(paging,search,filter);
