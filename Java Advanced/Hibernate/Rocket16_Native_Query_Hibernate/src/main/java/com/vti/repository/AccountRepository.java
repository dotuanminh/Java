		...
		try {
			...
			NativeQuery query = session.createNativeQuery(
					"SELECT a.AccountID, a.Email, a.Username,a.Fullname,d.DepartmentName,p.PositionName FROM Account a \r\n"
							...
							+ "INNER JOIN Position p on a.DepartmentID = p.PositionID ; \r\n");
			// Phần query này sẽ tạo ra 1 list các array object, sử dụng vòng lặp
			// foreach để truy vấn tới các phần tử trong array, lấy các giá trị trong DB
			// theo Index của array bắt đầu từ 0.
...
//	Lấy danh sách Account được tạo trong tháng hiện tại và sắp xếp theo ngảy tạo giảm dần hoặc tăng dần.
	public List<Account> get_ByCurrentMonthOderBy() throws ParseException, java.text.ParseException {
